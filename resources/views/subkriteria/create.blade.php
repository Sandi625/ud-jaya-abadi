...
<div class="container py-4">
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <h3 class="mb-4 text-dark fw-bold">Tambah Subkriteria</h3>
            ...
            <form action="{{ route('subkriteria.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="is_core_factor" value="1" class="form-check-input" id="is_core_factor" {{ old('is_core_factor') ? 'checked' : '' }}>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="profil_standar" name="profil_standar" value="{{ old('profil_standar') }}" min="1" max="4" class="form-control @error('profil_standar') is-invalid @enderror">
